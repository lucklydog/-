...
<body>
	...
	<div id="adminListTb" style="padding:2px 5px;">
		<a href="javascript:void(0)" class="easyui-linkbutton"
			iconCls="icon-add" onclick="addAdminInfo();" plain="true">添加管理员</a> 
			
			<a href="javascript:void(0)" class="easyui-linkbutton"
			iconCls="icon-remove" onclick="deleteAdminInfo();" plain="true">删除管理员</a>
	...
	return pnodes+","+cnodes;
		...
		function deleteAdminInfo() {
			...
			if (rows.length > 0) {
				...
				$.messager.alert('提示', '请选择要删除的管理员', 'info');
			}
		}
	</script>
</body>
